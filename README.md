...
<p>This repository will be used to manage field, time and schedule</p>

<h3>Directory Structure</h3>

```
field-service
    L client                         → Contains the client for calling other
...
- download json from your GCS account and place on config.json
```
